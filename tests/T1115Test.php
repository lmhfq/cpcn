...
use Lmh\Cpcn\Request\TrdT1115Request;
use Lmh\Cpcn\Response\TrdT1115Response;
use Lmh\Cpcn\Constant\ResponseCode;
use Lmh\Cpcn\TrdClient;
use PHPUnit\Framework\TestCase;

class T1115Test extends TestCase
{
    ...
    public function test()
    {
        ...
        $trdT1001Request = new TrdT1115Request();
        /**
         * @var TrdT1115Response $response
         */
        $response = $trdClient->execute($trdT1001Request, new TrdT1115Response());
