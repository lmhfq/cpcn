...
use Lmh\Cpcn\Request\TrdT4005Request;
use Lmh\Cpcn\Response\TrdT4005Response;
use Lmh\Cpcn\Constant\ResponseCode;
use Lmh\Cpcn\TrdClient;
use PHPUnit\Framework\TestCase;

class T4005Test extends TestCase
{
    ...
    public function test()
    {
        ...
        $trdT1001Request = new TrdT4005Request();
        /**
         * @var TrdT4005Response $response
         */
        $response = $trdClient->execute($trdT1001Request, new TrdT4005Response());
