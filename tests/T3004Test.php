...
use Lmh\Cpcn\Request\TrdT3004Request;
use Lmh\Cpcn\Response\TrdT3004Response;
use Lmh\Cpcn\Constant\ResponseCode;
use Lmh\Cpcn\TrdClient;
use PHPUnit\Framework\TestCase;

class T3004Test extends TestCase
{
    ...
    public function test()
    {
        ...
        $trdT1001Request = new TrdT3004Request();
        /**
         * @var TrdT3004Response $response
         */
        $response = $trdClient->execute($trdT1001Request, new TrdT3004Response());
