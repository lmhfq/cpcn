...
use Lmh\Cpcn\Request\TrdT4002Request;
use Lmh\Cpcn\Response\TrdT4002Response;
use Lmh\Cpcn\Constant\ResponseCode;
use Lmh\Cpcn\TrdClient;
use PHPUnit\Framework\TestCase;

class T4002Test extends TestCase
{
    ...
    public function test()
    {
        ...
        $trdT1001Request = new TrdT4002Request();
        /**
         * @var TrdT4002Response $response
         */
        $response = $trdClient->execute($trdT1001Request, new TrdT4002Response());
